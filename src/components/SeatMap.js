    ...
    return <div id="seatStatus" className="table-responsive" style={{overflow: 'hidden',marginTop:'20px'}}>
      ...
      <table className="table table-bordered table-hover table-striped table-condensed">
        ...
        <tr>
          ...
          <td id="6">
            <div>
              <div className="row dcs-seat">
                <div className="col-xs-3">
                  <div className="row">
                    <div className="col-xs-12 seat-left"></div>
                    <div className="col-xs-12 seat-left"></div>
                    <div className="col-xs-12 seat-left"></div>
                  </div>
                </div>
                <div className="col-xs-1"></div>
                <div className="col-xs-5 seat-middle seat-r">R</div>
                <div className="col-xs-3">
                  <div className="row">
                    <div className="col-xs-12 seat-right"></div>
                    <div className="col-xs-12 seat-right"></div>
                    <div className="col-xs-12 seat-right"></div>
                  </div>
                </div>
          ...
          <td id="12">
            <div>
              <div className="row dcs-seat">
                ...
                <div className="col-xs-1"></div>
                <div className="col-xs-5 seat-middle seat-start">*</div>
                <div className="col-xs-3">
                  <div className="row">
                    <div className="col-xs-12 seat-right"></div>
                    <div className="col-xs-12 seat-right"></div>
          ...
          <td id="36">
            <div>
              <div className="row dcs-seat">
                ...
                <div className="col-xs-1"></div>
                <div className="col-xs-5 seat-middle ">X</div>
                <div className="col-xs-3">
                  <div className="row">
                    <div className="col-xs-12 seat-right"></div>
                    <div className="col-xs-12 seat-right"></div>
          ...
          <td id="60">
            <div>
              <div className="row dcs-seat">
                <div className="col-xs-3">
                  <div className="row">
                    <div className="col-xs-12 seat-left">c</div>
                    <div className="col-xs-12 seat-left"></div>
                    <div className="col-xs-12 seat-left"></div>
                  </div>
                </div>
                <div className="col-xs-1"></div>
                <div className="col-xs-5 seat-middle seat-o">O</div>
                <div className="col-xs-3">
                  <div className="row">
                    <div className="col-xs-12 seat-right"></div>
                    <div className="col-xs-12 seat-right"></div>
          ...
          <td id="72">
            <div>
              <div className="row dcs-seat">
                ...
                <div className="col-xs-1"></div>
                <div className="col-xs-5 seat-middle seat-ce">C</div>
                <div className="col-xs-3">
                  <div className="row">
                    <div className="col-xs-12 seat-right"></div>
                    <div className="col-xs-12 seat-right"></div>
          ...
          <td id="1">
            <div>
              <div className="row dcs-seat">
                <div className="col-xs-3">
                  <div className="row">
                    <div className="col-xs-12 seat-left">v</div>
                    <div className="col-xs-12 seat-left">a</div>
                    <div className="col-xs-12 seat-left"></div>
                  </div>
                </div>
                <div className="col-xs-1"></div>
